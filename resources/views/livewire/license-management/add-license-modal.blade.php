<div>
    <!-- Trigger Button -->
    <button wire:click="openModal" class="inline-block px-8 py-2 m-0 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-[#333673] shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">+&nbsp; Add License</button>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-75">
        <div class="bg-white p-6 rounded-lg shadow-lg w-2/3 h-2/3 relative overflow-y-auto">
            ...
            <h2 class="text-xl font-semibold mb-4">Add License</h2>
            ...
            <form wire:submit.prevent="createLicense">
                 ...
                 <div class="grid grid-cols-3 gap-4 mb-4">
                     <div>
                         ...
                         <input wire:model="email" type="email" id="email" placeholder="Email" class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full rounded-lg border border-gray-300 px-3 py-2" required>
                         @error('email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                     </div>
                     <div>
                         <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                         <input wire:model="password" type="password" id="password" placeholder="Password" value="password" class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full rounded-lg border border-gray-300 px-3 py-2" required>
                         @error('password') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                     </div>
                     <div>
                         <label for="confirm_password" class="block text-sm font-medium text-gray-700">Confirm Password</label>
                         <input wire:model="confirm_password" type="password" id="confirm_password" placeholder="Confirm Password" class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full rounded-lg border border-gray-300 px-3 py-2" required>
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input wire:model.lazy="issued_date" type="date" id="issued_date" class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full rounded-lg border border-gray-300 px-3 py-2" required
