                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                    <h3 class="relative z-10 font-bold text-transparent bg-gradient-to-r from-[#333673] to-[#333673] bg-clip-text">
                                        Traffic Police Login</h3>
                                </div>
                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    <div id="alert"
                                        class="relative p-4 pr-12 mb-4 text-white border border-solid rounded-lg bg-gradient-to-r from-[#333673] to-[#333673] border-slate-100">
                                        {{ Session::get('status') }}
                                    ...
                                    <form wire:submit="login">
                                        ...
                                        <div class="mb-4">
                                            <input wire:model.blur="email" type="email"
                                                class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all  focus:outline-none focus:transition-shadow"
                                ...
                                <div
                                    ...
                                    <p class="mx-auto mb-6 leading-normal text-size-sm">
                                        ...
                                        <a href="/"
                                            class="relative z-10 font-semibold text-transparent bg-gradient-to-r from-[#333673] to-[#333673] bg-clip-text">here</a>.<br />
                                        Don't have an account?
                                        <a href="/"
                                            class="relative z-10 font-semibold text-transparent bg-gradient-to-r from-[#333673] to-[#333673] bg-clip-text">Sign
                                            up</a>.
                                    </p>
                                </div>
                            </div>
