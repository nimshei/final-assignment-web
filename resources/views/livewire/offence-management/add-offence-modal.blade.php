<div>
    <!-- Trigger Button -->
    <button wire:click="openModal" class="inline-block px-8 py-2 m-0 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-[#333673] shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">+&nbsp; Add Offence</button>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-75">
        <div class="bg-white p-6 rounded-lg shadow-lg w-2/3 relative">
            ...
            <h2 class="text-xl font-semibold mb-4">Add Offence</h2>

            <form wire:submit.prevent="createOffence">
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input wire:model="date_time" type="datetime-local" id="date_time" class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:outline-none focus:transition-shadow" step="60" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input wire:model="court_date" type="datetime-local" id="court_date" class="focus:shadow-[0_0_8px_rgba(0,0,255,0.5)] text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:outline-none focus:transition-shadow" step="60">
                ...
                <div class="flex justify-end mt-4">
                    ...
                    <button type="submit" class="inline-block px-8 py-2 m-0 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-green-900 shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">Add Offence</button>
                </div>
            </form>
        </div>
    </div>
